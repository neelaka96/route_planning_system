...
function select_city() {
    ...
    console.log(city);
    const api_url_filter = "http://localhost/gmap/maps.php?city=" + city;
...
function initMapw() {
    ...
    const myLatLng = { lat: parseFloat(data[0].split(":")[0]), lng: parseFloat(data[0].split(":")[1]) };
    ...
    if (data.length > 0) {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            new google.maps.Marker({
                ...
                map,
                title: "DEVELOPED BY UDARA LIYANAGE",
            });
